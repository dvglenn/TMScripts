...
(function() {
    ...
    for(let row of table.rows) {
        if (cnt>0) {
            var txt = row.cells[0].innerHTML;
            txt = txt + " <a target='dg' href='https://aftlite-portal.amazon.com/dock_receive/receive?receivable_order_id=" + txt + "'>Open</a>";
...
//     var sortTextDiv = document.createElement("div");
//     sortTextDiv.innerHTML = "*Click any column header to sort table on that column";
//     countDiv.innerHTML = "Count: " + count;
//     table.prepend(countDiv);
//     countDiv.append(sortTextDiv);
...
//             th.innerHTML = "Sortable Location";
...
//                         // Add additional table cell with bin location text re-arranged to be easier sorted
//                         var location = table.rows.item(i).cells.item(3).getElementsByTagName("p")[0].innerHTML;
//                         location = getSortableLocation(location);
//                         console.log(location);
//                         //DG TODO: Add "location" to table to be able to sort it
...
// function getSortableLocation(binLocation) {
//     //example input bin name:  P-1-A109E222
//     //example output bin name that is more easily sortable:  P-1-A109222E

//     var inputLocation = binLocation.trim();
//     var aisle = inputLocation.substring(0, 8);
//     var row = inputLocation.substring(8, 9);
//     var bin = inputLocation.substring(9)

//     return aisle + bin + row;
...
//  *  Tables sortable
//  *
//  * SOURCE:  https://github.com/tyleruebele/sort-table
//  */
