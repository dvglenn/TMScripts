...
function createFunctionTable(map) {
    ...
    for(let entry of sorted) {
        ...
        //DVGLENN CHANGES HERE
        var currentFunction = entry[1][0];
        if(currentFunction=="pack") {
        ...
        if(currentFunction=="receive/receive_direct" || currentFunction=="receive/receive2_direct") {
                action.innerHTML="<font color='blue'>"+currentFunction+"</font>";
                action.onclick = function() {
